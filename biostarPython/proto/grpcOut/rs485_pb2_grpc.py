...
import rs485_pb2 as rs485__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in rs485_pb2_grpc.py depends on'
...
def add_RS485Servicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('gsdk.rs485.RS485', rpc_method_handlers)
