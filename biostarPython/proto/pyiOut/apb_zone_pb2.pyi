...
class ReaderType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ENTRY: _ClassVar[ReaderType]
    EXIT: _ClassVar[ReaderType]
NO_RESET: Enum
...
class Member(_message.Message):
    __slots__ = ("deviceID", "readerType")
    DEVICEID_FIELD_NUMBER: _ClassVar[int]
    READERTYPE_FIELD_NUMBER: _ClassVar[int]
    deviceID: int
    readerType: ReaderType
    def __init__(self, deviceID: _Optional[int] = ..., readerType: _Optional[_Union[ReaderType, str]] = ...) -> None: ...
