...
import lift_zone_pb2 as lift__zone__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in lift_zone_pb2_grpc.py depends on'
...
def add_LiftZoneServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('gsdk.lift_zone.LiftZone', rpc_method_handlers)
