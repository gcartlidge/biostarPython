...
class RS485Stub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetConfigMulti = channel.unary_unary(
                '/gsdk.rs485.RS485/SetConfigMulti',
...
def add_RS485Servicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'gsdk.rs485.RS485', rpc_method_handlers)
...
class RS485(object):
    ...
    def SearchDevice(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.rs485.RS485/SearchDevice',
            rs485__pb2.SearchDeviceRequest.SerializeToString,
            rs485__pb2.SearchDeviceResponse.FromString,
    ...
    def GetDevice(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.rs485.RS485/GetDevice',
            rs485__pb2.GetDeviceRequest.SerializeToString,
            rs485__pb2.GetDeviceResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetDevice(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.rs485.RS485/SetDevice',
            rs485__pb2.SetDeviceRequest.SerializeToString,
            rs485__pb2.SetDeviceResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetConfig(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.rs485.RS485/GetConfig',
            rs485__pb2.GetConfigRequest.SerializeToString,
            rs485__pb2.GetConfigResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetConfig(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.rs485.RS485/SetConfig',
            rs485__pb2.SetConfigRequest.SerializeToString,
            rs485__pb2.SetConfigResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetConfigMulti(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.rs485.RS485/SetConfigMulti',
            rs485__pb2.SetConfigMultiRequest.SerializeToString,
            rs485__pb2.SetConfigMultiResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
